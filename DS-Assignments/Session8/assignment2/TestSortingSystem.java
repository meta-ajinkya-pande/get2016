...
public class TestSortingSystem {
	...
	public void testSortName(){
		...
		assertNotEquals("Quick Sort", sortingSystem.getSortName());
		//Quick Sort
		...
		assertNotEquals("Bubble Sort", sortingSystem.getSortName());
		//Counting Sort
		...
		assertNotEquals("Radix Sort", sortingSystem.getSortName());
		//Radix Sort
		...
		assertNotEquals("Counting Sort", sortingSystem.getSortName());
	}
