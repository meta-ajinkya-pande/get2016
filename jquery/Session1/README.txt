...
button with text: Show or hide depending on the span state, that is if span is visible it should show “Hide” and if span is hidden, it should show “Show”.

Write a javascript (not jQuery) that does those 3 actions on button click.

Assignment 2:
Re-write above assignment with jQuery.
